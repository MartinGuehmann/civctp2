...
uint32 const    k_BIT_GAME_OBJ_TYPE_UNFINISHED_IMPROVEMENT =
    (uint32) k_GAME_OBJ_TYPE_UNFINISHED_IMPROVEMENT << k_ID_MASK_SHIFT;
...
uint32 const    k_BIT_GAME_OBJ_TYPE_BUILT_IMPROVEMENT  =
    (uint32) k_GAME_OBJ_TYPE_BUILT_IMPROVEMENT << k_ID_MASK_SHIFT;
